require([], function() {
    ...
    String.prototype.utf8ToBase64 = function() {
        return base64EncArr(strToUTF8Arr(this));
    };

    String.prototype.base64ToUtf8 = function() {
        return UTF8ArrToStr(base64DecToArr(this));
    };

    String.prototype.utf8ToBase64NoPad = function() {
        return this.utf8ToBase64().replace(/(=){0,2}$/, '');
    };
